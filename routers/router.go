...
func InitAPI() {
	...
	beego.Router("/api/get-access-tokens", &controllers.ApiController{}, "GET:GetAccessTokens")
	...
	beego.Router("/api/get-image-app", &controllers.ApiController{}, "GET:GetImageApp")
	...
	beego.Router("/api/run-devbox", &controllers.ApiController{}, "POST:RunDevbox")
	...
	beego.Router("/api/preview-compose", &controllers.ApiController{}, "POST:PreviewCompose")
	beego.Router("/api/deploy-compose", &controllers.ApiController{}, "POST:DeployCompose")
	...
	beego.Router("/api/get-local-wsl-distros", &controllers.ApiController{}, "GET:GetLocalWSLDistros")
	beego.Router("/api/add-local-wsl-machine", &controllers.ApiController{}, "POST:AddLocalWSLMachine")
	beego.Router("/api/get-local-wsl-machine-status", &controllers.ApiController{}, "GET:GetLocalWSLMachineStatus")
	...
	beego.Router("/api/upgrade-helm-release-stream", &controllers.ApiController{}, "POST:UpgradeHelmReleaseStream")
